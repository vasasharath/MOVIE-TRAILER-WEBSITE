import webbrowser  #importing webbrowser package which will help to  
                   #open the youtube url of the specific movie
class Movie():
    ...
    def __init__(self, movie_title, movie_storyline, poster_image,
        ...
        self.title = movie_title   # initializing each property with
