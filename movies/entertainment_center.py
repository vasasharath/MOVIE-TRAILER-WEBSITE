...
home_alone = media.Movie("Home Alone",
                          ...
                          "https://upload.wikimedia.org/wikipedia/en/a/ab/HomeAloneCollectionDVD.jpg",
...
curve = media.Movie("Curve",
                    ...
                    "automobile accident.",
                    "https://upload.wikimedia.org/wikipedia/en/3/38/Curve_Poster.jpg",
...
fresh_tomatoes.open_movies_page(movies) # passing the movies array to
                                        # open_movies_page method which has
                                        # the layout to display as a webpage
